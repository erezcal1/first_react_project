...
import AmazonImgComponent from "../../components/amazonImg/AmazonImg.component";
...
const AmazonFakePage = () => {
  return (
    <Fragment>
      <div className="row">
        {initial_Products.map((product) => (
          <CardItemComponent key={product.id} {...product}></CardItemComponent>
        ))}
      </div>
      <div className="row">
        <AmazonImgComponent></AmazonImgComponent>
      </div>
      <div className="row"></div>
    </Fragment>
  );
};
export default AmazonFakePage;
